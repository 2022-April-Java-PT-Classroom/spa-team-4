        ...
        loadingOne || loadingTwo ? <h3>Loading Art...</h3> :
            <div className={style.singlePage}>
                ...
                <section className={style.art}>
                    <p className={style.titleArt}>Title: {artWork.title}</p>
                    <p>{artWork.artistDisplayName}</p>
                    <p>Department: {artWork.department}</p>
                    <p>Date: {artWork.objectDate}</p>
                    <p>Location: {artWork.repository}</p>
                ...
                <section className={style.art}>
                    <p className={style.titleArt}>Title: {artWorkNumTwo.title}</p>
                    <p>{artWorkNumTwo.artistDisplayName}</p>
                    <p>Department: {artWorkNumTwo.department}</p>
                    <p>Date: {artWorkNumTwo.objectDate}</p>
                    <p>Location: {artWorkNumTwo.repository}</p>
                    <div className={style.artImg}>
